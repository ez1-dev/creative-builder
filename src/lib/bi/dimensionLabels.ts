...
const DIM_SPECS: Record<LabelDimension, DimSpec> = {
  cliente: {
    ...
    labelKeys: ['categoria_label', 'serie_label', 'cliente_label', 'display_label'],
  },
  revenda: {
    codeKeys: ['cd_rev_pedido', 'cd_revenda'],
    nameKeys: ['nm_revenda', 'ds_revenda', 'revenda', 'nm_fantasia'],
    labelKeys: ['categoria_label', 'serie_label', 'revenda_label', 'display_label'],
  },
  estado: {
    codeKeys: ['cd_estado', 'uf', 'sg_uf'],
    nameKeys: ['nm_estado', 'estado'],
    labelKeys: ['categoria_label', 'serie_label', 'estado_label', 'display_label'],
  },
  obra: {
    codeKeys: ['cd_prj', 'cd_obra', 'numero_projeto', 'cd_projeto'],
    nameKeys: ['ds_obra', 'ds_abr_prj', 'nm_projeto', 'nome_projeto', 'projeto'],
    labelKeys: ['categoria_label', 'serie_label', 'obra_label', 'projeto_label', 'display_label'],
  },
  produto: {
    codeKeys: ['cd_produto'],
    nameKeys: ['ds_produto', 'descricao_produto', 'descricao', 'nm_produto'],
    labelKeys: ['categoria_label', 'serie_label', 'produto_label', 'display_label'],
  },
};
