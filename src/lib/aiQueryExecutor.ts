...
const MODULE_MAP: Record<string, ModuleConfig> = {
  ...
  'apontamento-genius': {
    endpoint: '/api/apontamentos-producao',
    defaultOrderBy: 'data_movimento',
    defaultFields: ['numero_op', 'nome_operador', 'numcad', 'descricao_produto', 'horas_realizadas', 'data_movimento', 'status_movimento'],
    permissionPath: '/auditoria-apontamento-genius',
    description: 'Apontamento de horas em ordens de produção da unidade GENIUS (endpoint /api/apontamentos-producao). Campos novos: status_movimento, horas_realizadas (em minutos), data_movimento, data_inicio/hora_inicio, nome_operador, numcad.',
    availableFilters: ['numop', 'operador', 'codpro', 'codori', 'status_op', 'data_ini', 'data_fim', 'somente_discrepancia', 'somente_acima_8h'],
    example: '"OPs Genius acima de 8 horas" → somente_acima_8h:1, order_by:"horas_realizadas"',
    countUnit: { field: 'numero_op', label: 'OPs' },
  },
