      ...
      >
        {!selectedScreen ? (
          ...
          <div className="flex flex-col h-full">
            ...
            {/* Cabeçalho das colunas de permissão */}
            <div className="flex items-center justify-between px-4 py-2 border-b bg-muted/30 text-[11px] font-medium uppercase tracking-wide text-muted-foreground">
              <div>Perfil</div>
              <div className="grid grid-cols-3 gap-2 w-[210px] shrink-0 text-center">
                <span>Ver</span>
                <span>Editar</span>
                <span>Excluir</span>
              </div>
                ...
                {profiles.map(p => {
                  ...
                  return (
                    <div key={p.id} className="flex items-center justify-between gap-3 px-4 py-3 hover:bg-muted/40">
                      ...
                      <div className="grid grid-cols-3 gap-2 w-[210px] shrink-0 items-center justify-items-center">
                        <Switch
                          checked={canView}
