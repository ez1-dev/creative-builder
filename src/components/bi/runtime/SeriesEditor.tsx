      ...
      {value.map((s, i) => (
        <div key={i} className="grid gap-2 rounded-md border bg-muted/30 p-2 md:grid-cols-12 items-end">
          <div className="md:col-span-4">
            <Label className="text-[10px] uppercase text-muted-foreground">Métrica</Label>
          ...
          <div className="md:col-span-3">
            ...
            <Input className="h-8 text-xs" value={s.label ?? ''} placeholder="(automático)" onChange={(e) => update(i, { label: e.target.value })} />
          </div>
          {allowChartType && (
          ...
          <div className="md:col-span-2">
            <Label className="text-[10px] uppercase text-muted-foreground">Eixo</Label>
