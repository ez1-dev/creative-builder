        ...
        {kpis && (
          <>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
              ...
              <KPICard title="Com falta" value={formatNumber(usarGlobais && kpis.globais?.com_falta != null ? kpis.globais.com_falta : kpis.comFaltaPagina, 0)} icon={<AlertTriangle className="h-5 w-5" />} variant="destructive" index={3} tooltip="Itens onde o disponível é negativo" />
              ...
              <KPICard title="Compra insuficiente" value={formatNumber(usarGlobais && kpis.globais?.compra_insuficiente != null ? kpis.globais.compra_insuficiente : kpis.compraInsufPagina, 0)} icon={<AlertTriangle className="h-5 w-5" />} variant="destructive" index={5} tooltip="Falta cuja compra pendente não cobre" />
            </div>
