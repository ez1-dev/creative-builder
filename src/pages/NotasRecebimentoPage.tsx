...
const columns: Column<any>[] = [
  ...
  { key: "descricao_item", header: "Descrição Item" },
  ...
  { key: "descricao_centro_custo", header: "Descrição CCU" },
...
const FILTER_LABELS: Record<string, string> = {
  ...
  numero_oc_origem: 'OC Origem', codigo_item: 'Cód. Item', descricao_item: 'Descrição Item',
      ...
      {data && (
        <>
          ...
          <div className="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6">
            ...
            <KPICard index={2} title="Fornecedores" value={kpis.totalFornecedores} icon={<Users className="h-5 w-5" />} onClick={openDrillRoot} />
            <KPICard
              index={3}
