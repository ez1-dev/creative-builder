...
> **Veja também:**
> - [`backend-numero-serie-validacao-origem.md`](./backend-numero-serie-validacao-origem.md) — prevenção: OP × pedido com origens diferentes.
> - [`backend-numero-serie-contexto-op-correta.md`](./backend-numero-serie-contexto-op-correta.md) — `/contexto` deve retornar a OP do pedido informado, não OP de pedido antigo.
